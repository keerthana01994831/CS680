...
class FileSystemTest {
    ...
    ApfsDirectory home = new ApfsDirectory(root, "home", 0, localTime,"Apfs",localTime);
	ApfsDirectory code = new ApfsDirectory(home, "code", 0, localTime,"Apfs",localTime);
	...
	public void verifyDirectoryEqualityRoot() {
		String[] expected = {null, "true", "root", "0", localTime.toString(),"125", "2", "Apfs", "500", "Apfs",localTime.toString() };
		ApfsDirectory actual = root;
		assertArrayEquals(expected, dirToStringArray(actual));
		}
	@Test
	public void verifyDirectoryEqualityHome() {
		String[] expected = {"root", "true", "home", "0", localTime.toString(),"100", "4", "Apfs", "500", "Apfs",localTime.toString() };
